...
const storyPresent = false;
const viewStory = '';
const impartialScore = 0;
const objectScore = 0;
const accuracyScore = 0;
const relevencyScore = 0;
// styles
const pageStyles = {
  color: "#232129",
  padding: 96,
...
class getLinkForm extends React.Component {
    state = {
      link: "",
    }
